...
class ModelHandler:
    ...
    def log_model_loading(self, model_path: str, success: bool = True, partial: bool = False):
        """Log model loading status."""
        if success:
            if partial:
                self.console.print(f"[yellow]✅ Backbone weights loaded from {model_path} (partial loading)[/yellow]")
            else:
